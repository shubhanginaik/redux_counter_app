This repo contains all the exercises and demo I've done for the react-redux course as part of the Full Stack Web Development Program at [Business College Helsinki](http://bc.fi).
# Redux
